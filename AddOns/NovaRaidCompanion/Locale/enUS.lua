...
L["meTransferedThreatTricks"] = "%s threat trick'd to %s."; --These are a little different for different places.
L["otherTransferedThreatTricks"] = "%s trick'd %s threat to %s."; --These are a little different for different places.
