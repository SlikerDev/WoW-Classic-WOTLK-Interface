...
L["Version="] = "版本="
L["WARNING ONLY"] = "仅警告"
L["was created in an older version of GSE.  It has been updated to the current version however may need to be checked manually."] = "在较旧版本的GSE中创建.它已被更新到当前的版本,但你可能需要手动检查."
