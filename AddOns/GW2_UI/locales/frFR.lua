...
L["Last updated: "] = "Dernière mise à jour : "
...
It's strongly recommended that you update.]=] ] = "Une mise à jour |cFFFF0000majeure|r est disponible. Il vous est fortement conseillé de la télécharger."
...
L["Apply UI to all"] = "Appliquer l'échelle de l'ATH à toutes les fenêtres ajustables"
...
All previous settings will be lost.]=] ] = "Êtes-vous sur de vouloir charger les paramètres par défaut? Tous les réglages précédent seront perdus."
L["Ascending"] = "Ascendant"
L["Attempt to create URL links inside the chat."] = "Essaie de créer les liens URL dans la fenêtre de discussion."
...
L["Custom buff"] = "Amélioration personnalisée"
...
L["Display emotion icons in chat"] = "Afficher les icônes d'émotion dans la fenêtre de discussion."
...
L["Display LFG Icons in group chat."] = "Afficher les icônes de recherche de groupe dans la fenêtre de discussion du groupe."
...
L["Display the hyperlink tooltip while hovering over a hyperlink."] = "Afficher l'infobulle du lien hypertexte au survol de la souris."
...
L["Edit chat settings."] = "Éditer les réglages de la fenêtre de discussion."
L["Edit raid aura indicators."] = "Modifier les indicateurs d'auras de raid"
L["Edit raid buff bar."] = "Éditer la barre des améliorations de raid."
...
L["Emotion Icons"] = "Icônes d'émotion"
...
L["Enter the spell ID of the buff you wish to track. Only one spell ID is supported. To find the spell ID of the buff you want to track, enable IDs in the tooltip settings and mouse over the icon in your aura bar."] = "Entrer l'identifiant (spell ID) de l'amélioration que vous souhaitez suivre. Ne supporte qu'un seul identifiant à la fois. Pour trouver l'identifiant souhaité, activez les identifiants dans les réglages des infobulles et survolez l'icône sur la barre des améliorations."
L[ [=[Enter the spell ID which should be tracked by the dodge bar.
If no ID is entered, the default abilities based on your specialization and talents are tracked.]=] ] = "Entrez le numéro ID du sort qui doit être suivi par la barre de mouvement. Si aucun numéro ID n'est entré, c'est le sort par défaut, selon votre spécialisation et vos talents, qui sera suivi."
...
L["Hyperlink Hover"] = "Survol du lien hypertexte."
L["I"] = true
L["If enabled, an animated border will surround the missing raid buffs"] = "Si activé, une bordure animée entourera les améliorations manquantes sur le raid."
L["If enabled, the above settings will apply to buffs you have, instead of buffs you are missing"] = "Si activé, les réglages ci-dessus vont s'appliquer à vos améliorations actives, au lieu de vos améliorations manquantes."
...
L["In group or in raid"] = "En groupe ou en raid"
L["In raid"] = "En raid"
...
L["Invert raid buff bar"] = "Inverser la barre d'améliorations du raid"
L["Invert target frame"] = "Inverser la fenêtre de cible"
L["Item Count"] = "Nombre d'objets"
L["Join Discord"] = "Rejoindre le Discord"
L["Keyword highlight color"] = "Couleur de surlignage du mot-clé"
L["Keywords"] = "Mot-clés"
L["Left"] = "Gauche"
...
L["Missing Raid Buffs"] = "Améliorations de raid manquantes"
L["Missing Raid Buffs Bar"] = "Barre d'améliorations de raid manquantes"
...
This will cause unit frames to shrink or move to the next column.]=] ] = "Définit la hauteur maximale pour le cadre de raid. Les portraits des unités seront rétrécies ou déplacées à la colonne suivante."
...
This will cause unit frames to shrink or move to the next row.]=] ] = "Définit la largeur maximale pour le cadre de raid. Les portraits des unités seront rétrécies ou déplacées à la colonne suivante."
...
L["Shorten the channel names in chat."] = "Raccourcir le nom des canaux dans la fenêtre de discussion."
L["Show Aura Tooltips"] = "Afficher les infobulles des auras en combat"
L["Show auras below"] = "Afficher les améliorations en dessous"
...
L["Show Missing Raid Buffs Bar"] = "Afficher la barre des améliorations de raid manquantes"
...
L["Show Role Bar"] = "Afficher la barre de rôle"
...
L["Show tooltips of buffs and debuffs."] = "Afficher les infobulles des buffs et debuffs même si vous êtes en combat"
...
L["Spam Interval"] = "Intervalle de spam"
L["Spent:"] = "Dépensé:"
