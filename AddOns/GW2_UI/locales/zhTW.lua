...
L["%s Indicator"] = "%s圖示"
L["%s is performing a Ritual of Summoning."] = "%s 正在開門拉人，請幫忙點門。"
L["%s placed a portal to %s."] = "%s 開了%s傳送門。"
L["%s slot needs to repair, current durability is %d."] = "%s需要修理，目前耐久值為  %d。"
...
L["Adds descriptions for mythic keystone properties to their tooltips."] = "在傳奇鑰石的滑鼠提示中加入詞綴內容說明。"
...
L["Boss Button"] = "首領按鈕"
L["Boss frames: Separate Energy Bar"] = "首領框架: 分離能量條。"
L["Buff size"] = "增益圖示大小"
L["Buffs"] = "增益"
L["Button Spacing"] = "按鈕間距"
L["By growth direction"] = "依據延伸方向"
L["By position on screen"] = "依據畫面上的位置"
L["Calendar invite"] = "行事曆邀請"
L["Center"] = "中間"
L["Change the HUD size."] = "更改介面大小。"
L["Change the Minimap size."] = "更改小地圖大小。"
L["Changelog"] = "更新資訊"
L["Changes the chat font, timestamp color and name display"] = "更改聊天字體、時間戳記顏色和名字顯示方式。"
L["Chromie Time Frame"] = "克羅米時間框架"
...
L["Combat Override Key"] = "戰鬥中需要按住"
L["Combat Repeat"] = "戰鬥重複字數"
L["Compact Icons"] = "小圖示"
L["Complete"] = "結束"
L["Conduits"] = "靈印"
L["Coordinates"] = "坐標"
...
L["Created: "] = "建立時間: "
L["Credits"] = "製作群"
L["Ctrl & Shift Click: Toggle CPU Profiling"] = "Ctrl+Shift+左鍵: 切換 CPU 分析"
...
L["Deficit:"] = "虧損:"
L["Defines how the group is sorted"] = "隊伍如何排序"
L["Defines the sort order of the selected sort method"] = "所選排序方式的排列順序"
L["Descending"] = "遞減"
L["Developed by"] = "程式設計"
...
If no ID is entered, the default abilities based on your specialization and talents are tracked.]=] ] = [=[輸入位移技能條要追蹤的法術 ID。
...
L["Grid Size:"] = "格子大小:"
L["Group Frames"] = "隊伍框架"
L["GW2 chat message style"] = "GW2 聊天訊息樣式"
...
L["has appeared on the Minimap!"] = "已經出現在小地圖上!"
L["Health Globe"] = "血球"
...
L["Hold Shift: Memory Usage"] = "按住 Shift 鍵: 記憶體使用量"
L["Home Latency:"] = "本地延遲:"
L["Home Protocol:"] = "本地協定:"
L["Horizontal"] = "水平"
L["HUD Scale"] = "介面縮放"
...
L["If enabled, enabled bosses’ energy bars will be shown separately from their health bar."] = "啟用時，作用中的首領能量條會和血量條分開顯示。"
...
L["Index"] = "索引"
L["Indicate whether buffs you cast yourself should be separated before or after"] = "你所施放的增益要在前面或後面分開顯示"
L["Installation"] = "安裝程序"
...
L["Mark Quest Reward"] = "標示任務獎勵"
L["Marks the most valuable quest reward with a gold coin."] = "最有價值的任務獎勵加上金錢圖示。"
...
L["Modifier for IDs"] = "顯示 ID 的輔助鍵"
L["Modifier to hold to show the tooltip in combat."] = "在戰鬥中要顯示滑鼠提示的輔助按鍵。"
...
L["Number of messages you scroll for each step."] = "每次捲動的訊息行數。"
L["Number of repeat characters while in combat before the chat editbox is automatically closed, set to zero to disable."] = "戰鬥中重複輸入多少個字後會自動關閉聊天輸入框，設為 0 會停用此功能。"
L["Number of time in seconds to scroll down to the bottom of the chat window if you are not scrolled down completely."] = "沒有完全向下捲動時，捲動到聊天視窗最下面需要的時間 (以秒為單位)。"
L["O"] = "幹"
...
L["Player de/buff animation"] = "玩家增益/減益動畫效果"
L["Player Debuffs Growth Direction"] = "玩家減益圖示延伸方向"
L["Player frame in group"] = "隊伍中也要顯示自己"
L["Player frame in target frame style"] = "玩家框架使用目標框架風格"
...
L["Reset Character Data: Hold Shift + Right Click"] = "重置角色資料: 按住 Shift + 右鍵點擊"
L["Reset Session Data: Hold Ctrl + Right Click"] = "重置本次登入資料: 按住 Ctrl + 右鍵點擊"
L["Rested "] = "休息加成"
...
L["Scroll Interval"] = "捲動行數"
L["Scroll Messages"] = "捲動訊息"
L["Secure"] = "安全"
...
依據延伸: 永遠和框架延伸的方向相反。]=]
L["Settings are not available in combat!"] = "戰鬥中無法調整設定!"
L["Setup Chat"] = "設定聊天視窗"
L["Setup CVars"] = "設定 CVars 遊戲預設參數"
L["Shift Click: Collect Garbage"] = "Shift+左鍵: 收集垃圾"
L["Short Channels"] = "縮寫頻道名稱"
L["Shorten the channel names in chat."] = "聊天中的頻道名稱顯示成縮寫。"
L["Show alternative background texture"] = "顯示另一種背景材質"
L["Show an additional resource bar"] = "顯示額外資訊條"
L["Show Aura Tooltips"] = "顯示光環的滑鼠提示"
...
L["Show spell queue window on castingbar"] = "在施法條上顯示法術佇列視窗"
L["Show the remaining aura time as an animated overlay."] = "用動畫效果顯示光環的剩餘時間。"
L["Show Threat"] = "顯示仇恨值"
L["Show tooltips of buffs and debuffs."] = "顯示增益和減益效果的滑鼠提示說明。"
L["Show Upgrade Icon"] = "顯示升級圖示"
L["Show your player frame as part of the group"] = "在隊伍框架中顯示玩家自己。"
L["Shows an animation for new de/buffs"] = "新的增益/減益顯示動畫效果"
L["Shows the xp you got from that quest in % based on your total needed xp for next level."] = "顯示該任務所獲得的經驗值，是升級所需經驗值的多少 %。"
L["Skins"] = "美化外觀"
L["Skip"] = "繼續"
L["Socket Frame"] = "珠寶插槽"
...
L["Soulwell"] = "靈魂之井"
L["Spam Interval"] = "洗頻間隔時間"
L["Spent:"] = "花費:"
L["Stance Bar Growth Direction"] = "姿勢形態列展開方向"
L["Start installation"] = "開始安裝"
L["Talking Head"] = "說話的頭框架"
L["Target Info"] = "目標資訊"
L["Targeted by:"] = "被關注:"
L["Text has not loaded."] = "看到這個訊息時表示我們忘記載入一些文字。不過不用擔心，會有一些適合的範例文字來告訴您相關資訊，就像現在這樣。"
L["The following addon(s) are loaded, which can cause conflicts. By default, this setting is disabled."] = "下列已載入的插件可能會造成衝突，預設停用此功能模組。"
...
L["Zone Ability"] = "區域技能"
L["Spec is already assigned to a layout!"] = "專精已經分配過版面配置!"
L["New layout name:"] = "新的版面配置名稱:"
L["Are you sure you want to delete the selected layout?"] = "是否確定要刪除選擇的版面配置?"
L["Rename layout:"] = "重新命名版面配置:"
L["Assign layouts to a spec. The layout will be automatically changed on a spec switch.\n\nLayouts has always priority for profile settings."] = "將版面配置分配給專精。切換專精時會自動更改版面配置。\n\n版面配置會永遠優先用於設定檔。"
L["<Assign specializations>"] = "<分配專精>"
L["Bottom"] = "下方"
L["Health Bar Position"] = "沒有完全向下捲動時，捲動到聊天視窗最下面需要的時間 (以秒為單位)。"
