...
L["%s (%d)"] = "%s (%d)"
L["Level %d"] = "等级%d"
L["Level %d (requires %s)"] = "等级%d (requires %s)"
L["%d/%d"] = "%d/%d"
...
L["New empty template"] = "新建空方案"
L["Create a new template from scratch."] = "建立一个空的天赋方案"
L["Copy current talent spec"] = "复制当前方案"
L["Create a new template from your current spec."] = "从当前方案建立副本"
L["Clone selected"] = "从目标复制"
L["Make a copy of the current template."] = "以目前观察的天赋创建新的天赋方案."
