...
L["%s (%d)"] = "%s (%d)"
L["Level %d"] = "Nivel %d"
L["Level %d (requires %s)"] = "Nivel %d (requires %s)"
L["%d/%d"] = "%d/%d"
...
L["https://www.wowhead.com/wotlk/talent-calc/%s/%s"] = "https://es.wowhead.com/wotlk/talent-calc/%s/%s"
L["https://www.wowhead.com/wotlk/pet-talent-calc/%s/%s"] = "https://es.wowhead.com/wotlk/pet-talent-calc/%s/%s"
L["Send to ..."] = "Enviar a ..."
