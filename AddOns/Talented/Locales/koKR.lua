...
L["Toggle edition of the template."] = "템플릿의 편집 모드 전환"
L["Toggle editing of talents."] = "특성의 편집 모드 전환"
...
L["Talented cannot perform the required action because it does not have the required talent data available for class %s."] = "Talented가 %s 직업의 특성 데이타를 가지고 있지 않기 때문에 요구한 동작을 수행할수 없습니다."
...
L["http://tbc.wowhead.com/talent-calc/%s/%s"] = "http://ko.tbc.wowhead.com/talent-calc/%s/%s"
L["http://tbc.wowhead.com/petcalc#%s"] = "http://www.ko.tbc.wowhead.com/petcalc#%s"
L["http://classic.wowhead.com/talent-calc/%s/%s"] = "http://ko.classic.wowhead.com/talent-calc/%s/%s"
L["http://classic.wowhead.com/petcalc#%s"] = "http://www.ko.classic.wowhead.com/petcalc#%s"
L["https://www.wowhead.com/wotlk/talent-calc/%s/%s"] = "https://ko.wowhead.com/wotlk/talent-calc/%s/%s"
L["https://www.wowhead.com/wotlk/pet-talent-calc/%s/%s"] = "https://ko.wowhead.com/wotlk/pet-talent-calc/%s/%s"
L["Send to ..."] = "... 에게 보내기"
L["Enter the name of the character you want to send the template to."] = "템플릿을 보내고자 하는 캐릭터의 이름을 입력하세요."
...
L["Right-click to activate this spec"] = "우클릭으로 이 특성 활성화"
...
L["Create a new Template."] = "새로운 템플릿을 생성합니다."
L["New empty template"] = "새로운 빈 템플릿"
L["Create a new template from scratch."] = "스크래치로부터 새 템플릿을 생성합니다."
L["Copy current talent spec"] = "현재 특성 복사"
L["Create a new template from your current spec."] = "현재 특성으로부터 새 템플릿을 생성합니다."
L["Clone selected"] = "선택된 복제"
L["Make a copy of the current template."] = "현재 템플릿을 복제하여 만듭니다."
